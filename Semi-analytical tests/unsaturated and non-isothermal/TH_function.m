...
while fllag
    ...
    Jmatrix(1,2) = (1800793563611553*X3.cvsat(1))/18014398509481984 + (2*X3.Dv(1)*X3.cvsat(1))/X3.dz(1) + (41570*(x0(1) + 5463/20)*((X3.k(1)*X3.ksat(1))/((X3.R*log(x0(2))*(x0(1) + 5463/20))/(X3.M*X3.g*X3.he(1)))^(X3.lamda(1)*X3.yeeta(1)))^(1/2))/(441*X3.dz*x0(2)) -...
        (X3.R*X3.k(1)*X3.ksat(1)*X3.lamda(1)*X3.yeeta(1)*(x0(1) + 5463/20))/(2*X3.M*X3.g*X3.he*x0(2)*((X3.k(1)*X3.ksat(1))/((X3.R*log(x0(2))*(x0(1) + 5463/20))/(X3.M*X3.g*X3.he(1)))^(X3.lamda(1)*X3.yeeta(1)))^(1/2)*((X3.R*log(x0(2))*(x0(1) + 5463/20))/(X3.M*X3.g*X3.he(1)))^(X3.lamda(1)*X3.yeeta(1) + 1)) +...
    ...
    ks=(log(x0(2))*X3.R*(x0(1)+273.15) /(X3.M*X3.g)/(X3.he))^(-X3.lamda*X3.yeeta)*X3.ksat;
    k=(ks*X3.k(1))^0.5;
